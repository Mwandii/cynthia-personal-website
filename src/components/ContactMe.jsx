      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="max-w-md md:max-w-none mx-auto md:grid md:grid-cols-3 md:gap-8 space-y-8 md:space-y-0">
          ...
          <div className="flex md:flex-col items-start md:items-center gap-4 md:gap-3 md:text-center">
            <div className="w-12 h-12 flex items-center justify-center shrink-0 rounded-lg bg-indigo-50 text-indigo-900">
            ...
            <div className="flex-1">
              ...
              <a 
                ...
                className="text-base text-gray-600 hover:text-indigo-900 transition-colors"
              >
                +254-704-207-486
              </a>
            </div>
          ...
          <div className="flex md:flex-col items-start md:items-center gap-4 md:gap-3 md:text-center">
            ...
            <div className="flex-1">
              ...
              <a 
                ...
                className="text-base text-gray-600 hover:text-indigo-900 transition-colors break-all"
              >
                cynmumbua@gmail.com
              </a>
            </div>
